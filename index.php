...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="../img/fivecon3.png">
    ...
    <div class="container-fluid ">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body bg-dark">
          ...
          <li class="nav-item">
              <a class="nav-link active text-white" href="./ViewAlunos/index.php">A-------------</a>
            </li>
          </ul>
...
<button  id="btninscricao" class="btn btn-success"> Faça a inscrição do seu time aqui</button>
  ...
  <footer class="footer">
  <div class="txtf">O objetivo do nosso Projeto além de colocar em prática o nosso aprendizado, também tem o objetivo de arrecadar alimentos para pessoas que se encontram em condições de vulnerabilidade social, econômica e/ou cultural. </div>
